...
- The major different from ReplicaSet from ReplicaController is the **set-based selector (advance selector)** to manage pod whereas the ReplicaController use **equality-based** selector.
  ![](/Image/pasted-image-20240327140807.png)
