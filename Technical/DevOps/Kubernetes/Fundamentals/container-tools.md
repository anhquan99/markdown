...
- `dockershim`: A small software shim (`dockershim`) was introduced as part of the `kubelet` component specifically to fill in the gaps between Docker Engine and CRI.