...
- `firewalld` is the _Dynamic Firewall Manager_, which utilizes network/firewall zones which have defined levels of trust for network interface or connections.
